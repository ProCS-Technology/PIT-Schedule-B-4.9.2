...
function setRelativeInformation(msg) {
    ...
    if (msg.User.lstRelative != null) {
        ...
        for (var i = 0; i < msg.User.lstRelative.length; i++) {
            ...
            if (msg.User.lstRelative[i].relation.RELATION_NM == "Spouse") {
                if (isMarried == "No") {
                    str += '<td><select name="Status_Relation" disabled="disabled" id="ddlStatusRelation" class="form-control"><option value="' + msg.User.lstRelative[i].status + '">' + (msg.User.lstRelative[i].status == "NotApplicable" ? "Not Applicable" : msg.User.lstRelative[i].status) + '</option></select></td>';
                    str += '<td><input id="txtName" type="text" disabled="disabled" class="form-control" autocomplete="off" value="' + msg.User.lstRelative[i].relativeName + '" /></td>';
                    str += '<td><input id="txtEmail" type="text" disabled="disabled" class="form-control" autocomplete="off" value="' + msg.User.lstRelative[i].relativeEmail + '" /></td>';
                    ...
                    if (msg.User.lstRelative[i].identificationType == "PAN") {
                        str += '<td><input id="txtIdentificationNumberRelation" disabled="disabled" type="text" class="form-control text-uppercase validatepan" name="identification_number_relation" autocomplete="off" value="' + msg.User.lstRelative[i].panNumber + '" /></td>';
                    }
                    else {
                        str += '<td><input id="txtIdentificationNumberRelation" disabled="disabled" type="text" class="form-control text-uppercase validatepan" name="identification_number_relation" autocomplete="off" value="' + msg.User.lstRelative[i].identificationNumber + '" /></td>';
                    }
                    str += '<td><input id="txtAddressRelation" type="text" disabled="disabled" class="form-control" autocomplete="off" value="' + msg.User.lstRelative[i].address + '" /></td>';
                    str += '<td><input id="txtPhoneRelation" type="text" disabled="disabled" maxlength="10" class="form-control" autocomplete="off" value="' + msg.User.lstRelative[i].mobile + '" onkeypress="return event.charCode >= 48 && event.charCode <= 57" /></td>';
                    str += '<td style="display:none;"></td>';
                    str += '<td>';
                    if ((msg.User.lstRelative[i].IsdesignatedPerson).toUpperCase() == "YES") {
                        str += '<input id="txtdpPan" type="checkbox" disabled="disabled" checked="checked" />';
                    }
                    else {
                        str += '<input id="txtdpPan" disabled="disabled" type="checkbox" />';
                    }
                    str += '</td>';
                    ...
                    //}
                    //str += "</div></td>";
                    str += '<td style="display:none;">' + msg.User.lstRelative[i].IsMandatory + '</td>';
                    str += '</tr>';
                }
                else {
                    str += '<td><select name="Status_Relation" id="ddlStatusRelation" class="form-control"><option value="' + msg.User.lstRelative[i].status + '">' + (msg.User.lstRelative[i].status == "NotApplicable" ? "Not Applicable" : msg.User.lstRelative[i].status) + '</option></select></td>';
                    str += '<td><input id="txtName" type="text" class="form-control" autocomplete="off" value="' + msg.User.lstRelative[i].relativeName + '" /></td>';
                    str += '<td><input id="txtEmail" type="text" class="form-control" autocomplete="off" value="' + msg.User.lstRelative[i].relativeEmail + '" /></td>';
                    str += '<td><select name="identification_type_relation" id="ddlIdentificationTypeRelation" class="form-control validatepan"><option value="' + msg.User.lstRelative[i].identificationType + '">' + (msg.User.lstRelative[i].identificationType == "NotApplicable" ? "Not Applicable" : msg.User.lstRelative[i].identificationType) + '</option></select></td>';
                    if (msg.User.lstRelative[i].identificationType == "PAN") {
                        str += '<td><input id="txtIdentificationNumberRelation" type="text" class="form-control text-uppercase validatepan" name="identification_number_relation" autocomplete="off" value="' + msg.User.lstRelative[i].panNumber + '" /></td>';
                    }
                    else {
                        str += '<td><input id="txtIdentificationNumberRelation" type="text" class="form-control text-uppercase validatepan" name="identification_number_relation" autocomplete="off" value="' + msg.User.lstRelative[i].identificationNumber + '" /></td>';
                    }
                    str += '<td><input id="txtAddressRelation" type="text" class="form-control" autocomplete="off" value="' + msg.User.lstRelative[i].address + '" /></td>';
                    str += '<td><input id="txtPhoneRelation" type="text" maxlength="10" class="form-control" autocomplete="off" value="' + msg.User.lstRelative[i].mobile + '" onkeypress="return event.charCode >= 48 && event.charCode <= 57" /></td>';
                    str += '<td style="display:none;"></td>';
                    str += '<td>';
                    if ((msg.User.lstRelative[i].IsdesignatedPerson).toUpperCase() == "YES") {
                        str += '<input id="txtdpPan" type="checkbox" checked="checked" />';
                    }
                    else {
                        str += '<input id="txtdpPan" type="checkbox" />';
                    }
                    str += '</td>';
                    str += "<td><div class='tools'>";
                    str += '<a id="edit_"' + i + ' onclick="javascript:SetEditRelation(this);" style="margin-right:10px;">';
                ...
                str += '<td><input id="txtAddressRelation" disabled="disabled" type="text" class="form-control" autocomplete="off" value="' + msg.User.lstRelative[i].address + '" /></td>';
                str += '<td><input id="txtPhoneRelation" disabled="disabled" type="text" maxlength="10" class="form-control" autocomplete="off" value="' + msg.User.lstRelative[i].mobile + '" onkeypress="return event.charCode >= 48 && event.charCode <= 57" /></td>';
                str += '<td style="display:none;"></td>';
                str += '<td>';
                if ((msg.User.lstRelative[i].IsdesignatedPerson).toUpperCase() == "YES") {
                    str += '<input id="txtdpPan" disabled="disabled" type="checkbox" checked="checked" />';
                }
                else {
                    str += '<input id="txtdpPan" disabled="disabled" type="checkbox" />';
                }
