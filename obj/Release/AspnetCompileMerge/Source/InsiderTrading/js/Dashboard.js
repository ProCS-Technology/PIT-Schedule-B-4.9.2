        ...
        success: function (msg) {
            if (msg.StatusFl == true) {
                ...
                for (var i = 0; i < msg.InsiderTradingWindowList.length; i++) {
                    if (convertToDateTime(msg.InsiderTradingWindowList[i].toDate) == "31/12/9999") {
                        result += "Please Note: The Trading Window is closed from " + msg.InsiderTradingWindowList[i].fromDate + " to till further notified " + msg.InsiderTradingWindowList[i].remarks;
                    }
                    else {
