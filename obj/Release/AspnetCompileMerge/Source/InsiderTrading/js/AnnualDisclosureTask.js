        ...
        success: function (msg) {
            ...
            if (msg.StatusFl == true) {
                ...
                for (var i = 0; i < msg.AnnualDisclosureTaskList.length; i++) {
                    ...
                    result += '<td id="tdAnnualDisclosureTasksd_' + msg.AnnualDisclosureTaskList[i].id + '">' + msg.AnnualDisclosureTaskList[i].STARTDATE + '</td>';
...
function fnValidate() {
    ...
    //else if (!/^[a-zA-Z ]*$/.test(FINANCIAL_YEARS)) {
...
function fnClearForm() {
    ...
    // $('#txtAnnualDisclosureTaskKey').val("");
