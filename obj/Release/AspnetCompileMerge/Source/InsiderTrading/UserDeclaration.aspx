                ...
                <div class="portlet light portlet-fit " id="form_wizard_1">
                    ...
                    <div class="portlet-body form">
                        <form class="form-horizontal" action="#" id="submit_form" method="post">
                             <input id="hdnTaskFor" type="hidden" runat="server"  />
                            <input id="hdnTaskId" type="hidden" runat="server"  />
                            <input id="hdnTaskStatus" type="hidden" runat="server"  />
                            <input id="hdnTaskFrm" type="hidden" runat="server"  />
                            <input id="HiddenTaskStatus" type="hidden" runat="server"  />
                            <input id="hdnFinalDeclared" type="hidden" runat="server"  />
                                ...
                                <div class="form-body">
                                    ...
                                    <div class="tab-content">
                                        ...
                                        <div class="tab-pane active" id="tab1">
                                            <h5 style="padding-left: 23px; color: blue;">Provide your personal details<br />
                                                <span style="color: red;">
                                                    <strong>Note : Please check your details. In case of any discrepancy, kindly contact <a runat="server" id="linkSupportMail" href="#">administrator.</a></strong>
                                                </span>
                                                 <span id="spnRequest" style="float:right;padding-right:50px;">
                                            ...
                                            <div class="form-group" id="dvMaritalStatus">
                                            ...
                                            <div class="form-group" id="dvCheckbox">
                                                <label id="lblCheckbox" class="control-label col-md-3">
                                                    Click here if you want to review and resubmit your last declaration<span class="required" id="spnCheckbox"></span>
                                                </label>
                                                <div class="col-md-4">
