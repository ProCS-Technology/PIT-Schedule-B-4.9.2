...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
                ...
                <div class="portlet light portlet-fit ">
                    ...
                    <div class="portlet-body">
                        ...
                        <table class="table table-striped table-hover table-bordered" id="tbl-AnnualDisclosureTask-setup">
                            ...
                            <tbody id="tbdAnnualDisclosureTaskList">
                            </tbody>
                        </table>
                    </div>
                </div>
    ...
    <%-- ========================= Add New Record in AnnualDisclosureTask  ============================= --%>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <input id="txtstartDt" class="form-control form-control-inline date-picker" placeholder="Enter start Date" size="16" type="text" autocomplete="off" <%--onchange="removeRedClass('txtFromDt', 'lblValidDt')--%>" />
               ...
               <div class="row">
                        ...
                        <div class="col-md-6">
                            <input id="txtendDt" class="form-control form-control-inline " placeholder="Enter End Date" size="16" type="text" autocomplete="off" <%--onchange="removeRedClass('txtFromDt', 'lblValidDt')--%>" />
