                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="btn-group-devided">
                                ...
                                <select id="ddlUserStatusshowing" ">
                                    <option value="0" selected="selected">Showing</option>
                                </select>&nbsp;
                            ...
                            <div class="portlet-body form">
                                <div class="form-body">
                                    ...
                                    <div class="form-group" id="dvDateOfJoining">
                                        ...
                                        <div class="col-md-8">
                                            <input id="txtDateOfJoining" data-date-format="dd/mm/yyyy" type="text" class="form-control date-picker" />
                                        </div>
                                    </div>
                                    <br />
                                    <div class="form-group" id="dvDateOfBecomingInsider">
                                        ...
                                        <div class="col-md-8">
                                            <input id="txtDateOfBecomingInsider" data-date-format="dd/mm/yyyy" type="text" class="form-control date-picker" />
                                        </div>
                                    </div>
                                    <br />
                                    ...
                                    <div class="form-group" id="dvRetirementDate">
                                        ...
                                        <div class="col-md-8">
                                            <input id="txtDateOfRetirement" data-date-format="dd/mm/yyyy" type="text" class="form-control date-picker" />
                                        </div>
                                    </div>
                                    <br />
