<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/InsiderTrading/InsiderTradingMaster.Master" CodeBehind="UPSITask.aspx.cs" Inherits="ProcsDLL.InsiderTrading.UPSITask" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <script src="js/UPSITask.js?<%=DateTime.Now %>" type="text/javascript"></script>
</asp:Content>