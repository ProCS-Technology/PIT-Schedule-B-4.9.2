            ...
            <div class="modal-dialog modal-dialog-centered modal-lg modal-xl">
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title caption-subject bold uppercase font-red-sunglo">Add UPSI</h4>
                                ...
                                <div class="form-body">
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <input class="form-control form-control-inline date-picker" placeholder="Enter Shared On Date" size="16" type="text" autocomplete="off" id="txtUPSISharedOn" onchange="removeRedClass('txtUPSISharedOn','lblUPSISharedOn')" />
                                            </div>
                                            <div class="col-md-2">
