            ...
            <div class="portlet light bordered">
                <div class="portlet-title  tabbable-line">
                    ...
                    <div class="pull-right">
                        ...
                        <%--<div class="btn-group">
                            <a class="btn green btn-circle" href="#" data-toggle="dropdown" data-hover="dropdown" data-close-others="true" aria-expanded="true">
                                New Request<i class="fa fa-angle-down"></i>
                            </a>
                            <ul class="dropdown-menu pull-right">
                                <li>
                                    <a id="btnAdd" href="#" onclick="javascript:fnAddPreClearance();">Preclearance Request</a>
                            ...
                            <div class="col-md-4 col-lg-4">
                                ...
                                <div class="btn-group btn-group-devided" data-toggle="buttons">
                                    <label class="btn green btn-outline btn-circle active">
                                        <input type="radio" name="PreClearancestatus" class="toggle filter-status" value="" />All</label>
                                    <label class="btn  green btn-outline btn-circle">
                                        <input type="radio" name="PreClearancestatus" class="toggle filter-status" value="Self" />Self</label>
                                    <label class="btn  green btn-outline btn-circle">
                                        <input type="radio" name="PreClearancestatus" class="toggle filter-status" value="Relatives" />Relatives</label>
                                </div>
                            </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn dark btn-outline" data-toggle="modal" data-target="#modalNullTrade" id="btnnulltrade">Click Here to Report Null Trade</button>
        ...
        <div class="modal-dialog modal-full">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button id="btnSubmitTD" type="submit" class="btn btn-outline dark" onclick="javascript:fnSaveBrokerNote();">Skip</button>
