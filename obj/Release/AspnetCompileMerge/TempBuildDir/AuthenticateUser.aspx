<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AuthenticateUser.aspx.cs" Inherits="ProcsDLL.AuthenticateUser" %>
...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body class="login">
        ...
        <script>
            ...
            function InValidCredential(sUser, samlEndpoint) {
                alert("You are not authorized to access this application, please contact " + sUser + " for the access of the application.");
