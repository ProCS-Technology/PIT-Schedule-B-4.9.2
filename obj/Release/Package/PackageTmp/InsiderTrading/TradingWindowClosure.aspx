                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-8">
                                            <div class="input-group">
                                                ...
                                                <input id="txtTradingWindowFrom" class="form-control form-control-inline" onchange="javascript:fnRemoveClass(this,'From','txtTradingWindowFrom');" type="text" value="" autocomplete="off" />
                                            </div>
                                        </div>
                                    </div>
                                    <br />
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-8">
                                            <div class="input-group">
                                                ...
                                                <input id="txtTradingWindowTo" class="form-control form-control-inline" onchange="javascript:fnRemoveClass(this,'To','txtTradingWindowTo');" type="text" value="" autocomplete="off" />
                                            </div>
                                        </div>
                                    </div>
                                    <br />
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="form-body">
                    <div class="form-group" style="margin-left:15px; width: 95%;">
                        <label>User</label>
                        <select id="bindUser" runat="server" class="mt-multiselect btn btn-default" multiple 
                            data-placeholder="Select User(s)" data-label="left" data-select-all="true" data-width="100%" data-filter="true" 
                            data-action-onchange="true" visible="false">
                        </select>
                    </div>
                    <div class="form-group">
                        ...
                        <li>
                            ...
                            <ul>
                                <asp:DataList ID="Datalist1" runat="server" RepeatDirection="Vertical"
                                    ...
                                    <ItemTemplate>
                                        <li>
                                            <input type="checkbox" class="cbCheck" value='<%#Eval("RELATIVE_EMAIL") %>'  />
                                            <asp:Label ID="Itmnamelbl" Style="display: none" runat="server" Text='<%#Eval("RELATIVE_EMAIL") %>'></asp:Label>
                                            <asp:Label ID="Label6" runat="server" Text='<%#Eval("RELATIVE_NAME") %>'></asp:Label>
                                        </li>
                                    </ItemTemplate>
                                ...
                                <li>
                                    ...
                                    <ul>
                                        <asp:DataList ID="ddlCP" runat="server" RepeatDirection="Vertical">
                                            <ItemTemplate>
                                                <li>
                                                    <input type="checkbox" class="cbCheck" value='<%#Eval("USER_EMAIL") %>' />
                                                    <asp:Label ID="Label1" Style="display: none" runat="server" Text='<%#Eval("USER_EMAIL") %>'>
                                                    </asp:Label>
                                                    <asp:Label ID="Label3" runat="server" Text='<%#Eval("USER_NM") %>'>
                                                    </asp:Label>
                    ...
                    <div class="form-group" style="margin-left: 15px;">
                        <label>Attachment (Only pdf format upto 5MB)</label>
                        <input type="file" id="txtAttachment" />
                    </div>
                </div>
                <div class="modal-footer">
