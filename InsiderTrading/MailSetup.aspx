<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/InsiderTrading/InsiderTradingMaster.Master" CodeBehind="MailSetup.aspx.cs" Inherits="ProcsDLL.InsiderTrading.MailSetup" %>
...
<div class="portlet-title">
            <div class="caption font-red-sunglo">
                ...
                <span class="caption-subject bold uppercase">Mail Set Up</span>
            </div>
        </div>
                            ...
                            <div class="portlet-body form">
                                <form class="form-horizontal" runat="server" role="form">
                                    <div class="form-body modal-fixheight" id="">
                                        ...
                                        <label class="col-md-3 control-label" id="lblreminderName"><b>Mail Reminder</b></label>
                                        <div class="col-md-6">
   ...
   <script src="../assets/global/scripts/app.min.js" type="text/javascript"></script>
    ...
    <script src="js/MailSetup.js?<%=DateTime.Now %>" type="text/javascript"></script>   
    <%--<script src="js/MailSetup.js?<%=DateTime.Now %>" type="text/javascript"></script>--%>
