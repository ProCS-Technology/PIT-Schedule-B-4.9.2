<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/InsiderTrading/InsiderTradingMaster.Master" CodeBehind="PITDashboard.aspx.cs" Inherits="ProcsDLL.InsiderTrading.PITDashboard" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
        ...
        <div class="col-md-12">
            ...
            <div class="portlet box" id="dvMyActionable">
                ...
                <div class="portlet-body">
                    ...
                    <div id="Trade_PortletBox" class="portlet box My_Trade_PortletBox" style="" runat="server" visible="false">
                        <div data-toggle="collapse" id="Trade_PortletTitle" class="portlet-title" data-target="#TradeDetailsTab">
                            <div class="caption" style="padding-top: 6px !important; font-size: 18px;">
                                <i class="fa fa-gift"></i>Required Trade Disclosure(s)
                            </div>
                        ...
                        <div id="TradeDetailsTab" class="portlet-body form collapse in">
                            <form class="form-horizontal" role="form">
                                <table class="table table-striped table-hover table-bordered">
                                    ...
                                    <tbody id="tbodyPreClearance" runat="server"></tbody>
                                </table>
                            </form>
                        </div>
                    </div>
                    <div id="ActionableCompliance_PortletBox" class="portlet box My_Trade_PortletBox" runat="server" visible="false">
                        <div data-toggle="collapse" id="ActionableCompliance_PortletTitle" class="portlet-title" data-target="#ActionableComplianceTab">
                            <div class="caption" style="padding-top: 6px !important; font-size: 18px;">
                                <i class="fa fa-newspaper-o"></i>Reported Benpos Trades
                            </div>
                            <div class="tools" style="padding-top: 6px !important;">
                                ...
                                <table class="table table-striped table-hover table-bordered">
                                    <thead>
                                        <tr>
                                            ...
                                            <th rowspan="2">PAN</th>
                                            <th rowspan="2">DEMAT</th>
                                            <th rowspan="2">For</th>
                                            <th colspan="2" style="text-align:center;">Benpos Period</th>
                                    ...
                                    <tbody id="tbodyBenposTrade" runat="server"></tbody>
                                </table>
                            </form>
                        </div>
                    </div>
                    <div id="UPSI_PortletBox" class="portlet box My_Trade_PortletBox" runat="server" visible="false">
                        ...
                        <div id="UPSITab" class="portlet-body form collapse in">
                            <form class="form-horizontal" role="form"><br /><br /><br />
                                <table class="table table-striped table-hover table-bordered" id="tblUPSITask">
                                    <thead>
                                        <tr>
                                            <th>Email Date</th>
                                            <th>Email From</th>
                                    ...
                                    <tbody id="UPSITaskTbody" runat="server"></tbody>
                                </table>
                            </form>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12 margin-bottom-10">
                            <div class="dashboard-stat blue">
                                ...
                                <a class="more" href="PreClearance.aspx">View more<i class="m-icon-swapright m-icon-white"></i>
                                </a>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                            <div class="dashboard-stat purple">
                                ...
                                <a class="more" href="PreClearance.aspx?Status=InApproval">View more<i class="m-icon-swapright m-icon-white"></i>
                                </a>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                            <div class="dashboard-stat green-dark">
                                ...
                                <a class="more" href="PreClearance.aspx?Status=Approved">View more<i class="m-icon-swapright m-icon-white"></i>
                                </a>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                            <div class="dashboard-stat red">
                                ...
                                <a class="more" href="PreClearance.aspx?Status=Rejected">View more<i class="m-icon-swapright m-icon-white"></i>
                                </a>
                            </div>
                        </div>
                    </div>
                ...
                <div class="modal-body">
                    <form class="form-horizontal" role="form">
                        <div class="form-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-9">
                                    <div class="input-inline input-medium">
                                        ...
                                        <input type="hidden" runat="server" id="hdnCmpn" />
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-md-9">
                                    <div class="input-inline input-medium">
                                        <select id="ddlTypeOfTransactionBN" class="form-control">
                                        </select>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-md-9">
                                    <div class="input-inline input-medium">
                                        <div class="input-group">
                                            ...
                                            <input id="txtRequestedTransactionDateBN" disabled="disabled" class="form-control" type="text" value="" />
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group" id="dvMultiTrade" style="margin:15px;">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <input type="hidden" id="preClearanceRequestIdBN1" value="0" />
    ...
    <script src="js/PITDashboard.js?<%=DateTime.Now %>" type="text/javascript"></script>
    <script src="js/PITDashboardBN.js?<%=DateTime.Now %>" type="text/javascript"></script>
