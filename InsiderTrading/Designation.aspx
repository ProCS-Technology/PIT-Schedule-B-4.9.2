<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/InsiderTrading/InsiderTradingMaster.Master" CodeBehind="Designation.aspx.cs" Inherits="ProcsDLL.InsiderTrading.Designation" %>
                ...
                <div class="portlet light portlet-fit ">
                    <div class="portlet-title">
                        <div class="caption">
                            ...
                            <span class="caption-subject font-red sbold uppercase">Designation</span>
                        </div>
                    </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="btn-group-devided">
                                        <button id="btnAdd" runat="server" class="btn green" onclick="javascript:fnAddDesignation();" data-target="#stack1" data-toggle="modal">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <%--<input id="txtDesignationName" class="form-control" type="text" onkeypress="return /^[a-zA-Z ]*$/i.test(event.key)" data-tabindex="1" />--%>
                ...
                <div class="modal-footer">
                    ...
                    <button id="btnSave" type="button" data-dismiss="modal" class="btn green" onclick="javascript:fnSaveDesignation();">Save</button>
                </div>
            </div>
            <!-- /.modal-content -->
        </div>
