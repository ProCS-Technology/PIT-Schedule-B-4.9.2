<%@ Page Title="" Language="C#" MasterPageFile="~/InsiderTrading/InsiderTradingMaster.Master" AutoEventWireup="true" CodeBehind="UPSIGropMemberReport.aspx.cs" Inherits="ProcsDLL.InsiderTrading.UPSIGropMemberReport" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
        ...
        <div class="portlet light portlet-fit">
            <div class="portlet-title">
                <div class="caption">
                    ...
                    <span class="caption-subject font-red sbold uppercase">UPSI Member Report</span>
                </div>
                <div class="tools">
                </div>
            </div>
            <div class="portlet-body">
                <div class="row">
                    <div class="col-md-2 col-lg-2">
                        <label for="lblbindMemberType" style="text-align: center; display: block;">Member Type</label>
                        <select class="form-control select2" name="User" id="bindMemberType" onchange="GetAllUPSIGroup()">
                            <option value="0">Select</option>
                            <option value="DESIGNATED">DESIGNATED</option>
                            <option value="NONDESIGNATED">NONDESIGNATED</option>
                        </select>
                    </div>
                    <div class="col-md-4 col-lg-4">
                        <label for="User" style="text-align: center; display: block;">Member</label>
                         <div class="input-group select2-bootstrap-append" id="colupsiDesignatedM">
                                            <select id="ddlupsiDesignatedM" class="form-control select2" multiple="multiple"> </select>
    ...
    <script src="js/UPSIGroupMemberReports.js?<%=DateTime.Now %>" type="text/javascript"></script>
</asp:Content>
