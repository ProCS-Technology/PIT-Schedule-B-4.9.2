<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/InsiderTrading/InsiderTradingMaster.Master" CodeBehind="Pre-ClearanceReports.aspx.cs" Inherits="ProcsDLL.InsiderTrading.Pre_ClearanceReports" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
        ...
        <div class="portlet box">
            <div class="portlet-title">
                <div class="caption">
                    ...
                    <span class="caption-subject font-red sbold uppercase">Pre-Clearance Reports</span>
                </div>
                <div class="tools">
                </div>
            </div>
            <div class="portlet-body">
              ...
              <div class="portlet-body">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div style="text-align: center; margin-left:365px"><b>Total PreClearance</b></div>
                        <br />
                        <div id="chart_PreClearance" class="chart" style="height: 200px;align-content:center; margin-left:285px">
                        </div>
                    </div>
                  <%--  <div class="col-md-6">
                        <div style="text-align: center"><b>PreClearance Modifications</b></div>
                        <br />
                        <div id="chart_Modifications" class="chart" style="height: 200px;">
                        </div>
                    </div>--%>
                </div>
                <br />
                <br />
                <div class="row">
                    <div style="text-align: center"><b>User Details who have made their pre-clearance request</b></div>
                    <table class="table table-striped table-hover table-bordered" id="tbl-PreClearanceDetails-setup" style="margin-left: 16px;width: 1043px;">
                        <thead>
                            <tr>
                                <th>Name</th>
                                <th>Email Id</th>
                        ...
                        <tbody id="tbdPreClearanceDetailsList">
                            <tr>
                                <td>Akshay</td>
    ...
    <script src="js/Pre-ClearanceReports.js" type="text/javascript"></script>
</asp:Content>
