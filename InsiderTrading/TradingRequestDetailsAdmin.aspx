<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/InsiderTrading/InsiderTradingMaster.Master" CodeBehind="TradingRequestDetailsAdmin.aspx.cs" Inherits="ProcsDLL.InsiderTrading.TradingRequestDetailsAdmin" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
                ...
                <div class="portlet-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-2 col-lg-2" style="padding-top: 23px;">
                            <input id="txtGetTadingReport" type="button" style="background-color: limegreen;" class="form-control" value="Run" onclick="fnGetTradingRequestDetailsReport();" name="to_date" />
                        </div>
                    </div>
                    <br />
                    <br />
    ...
    <script src="js/TradingRequestDetailsAdmin.js?<%=DateTime.Now %>"></script>
