...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
                ...
                <div class="portlet light portlet-fit " id="form_wizard_1">
                    <div class="portlet-title">
                        <div class="caption">
                            ...
                            <span class="caption-subject font-red bold uppercase">User Declaration  -
                                <span class="step-title" id="spnTitle">
                                    Step 1 of 5 (PLEASE KEEP THE FOLLOWING DETAILS HANDY FOR FILLING UP THE FORM- PAN, 
                                    ...
                                    <div class="tab-content">
                                        ...
                                        <div class="tab-pane active" id="tab1">
                                            <h5 style="padding-left:23px;color:blue;">
                                                Provide your personal details<br />
                                                <span style="color:red;">
                                                    <strong>Note : Please check your details. In case of any discrepancy kindly contact administrator</strong>
                                                </span>
                                            </h5>
                                            ...
                                            <div class="form-group" id="dvEmployeeId">
                                                <label class="control-label col-md-3">Employee ID<span class="required" id="spnEmployeeId">* </span>                                                    
                                                </label>
                                                <div class="col-md-4">
                                            ...
                                            <div class="form-group" id="dvIdentification">
                                                ...
                                                <div class="col-md-4">
                                                    ...
                                                    <%--<span class="help-block">Provide Identification #</span>--%>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group" id="dvDoj">
                                                ...
                                                <div class="col-md-4">
                                                    <input id="txtDateOfJoining" runat="server" data-date-format="dd/mm/yyyy" type="text" class="form-control date-picker" name="date_Of_Joining" />
                                            ...
                                            <div class="form-group" id="dvBeomeInsider">
                                                ...
                                                <div class="col-md-4">
                                                    <input id="txtDateOfBecomingInsider" runat="server" data-date-format="dd/mm/yyyy" type="text" class="form-control date-picker" name="date_Of_Becoming_Insider" />
                                            ...
                                            <div class="form-group" id="dvInstitution">
                                                <label id="lblInstitution" class="control-label col-md-3">
                                                    Educational Institution/University of Graduation<span class="required" id="spnInstitution">* </span>
                                                </label>
                                                <div class="col-md-4">
                                                    ...
                                                    <span style="color: red;display:none">
                                                        All Educational Qualifications & Institutions – to be mentioned in a descending order separated by a comma (,) starting from your Graduation </span>
                                                </div>
                                            </div>
                                        ...
                                        <div class="tab-pane" id="tab2">
                                            <h5 style="padding-left:23px;color:blue;">
                                                Please provide dependent relative detail. Material financial relationship information if you 
                                                have provided more than 25% of your Annual Income to any Individual.
                                            </h5>
                                            <div style="margin-left: 20px" class="actions">
                                                <a class="btn btn-default" data-toggle="modal" data-target="#modalAddRelativeDetail" onclick="fnOpenModalAddRelativeDetail();">
                                                ...
                                                <table class="table table-striped table-hover table-bordered" id="tbl-Relative-setup" style="width: 1000px">
                                                    <thead class="text-uppercase">
                                                        <tr>
                                                            ...
                                                            <th>Edit</th>
                                                            <th style="display: none">Is Designated Person</th>
                                                        </tr>
                                                    </thead>
                                        ...
                                        <div class="tab-pane" id="tab3">
                                            <h5 style="padding-left:23px;color:blue;">
                                                Kindly provide details of DEMAT account of self and relative if any
                                            </h5>
                                            <div style="margin-left: 20px" class="actions">
                                        ...
                                        <div class="tab-pane" id="tab4">
                                            ...
                                            <div style="margin-left: 20px" class="actions">
                                                <a class="btn btn-default" data-toggle="modal" data-target="#modalAddInitialHoldingDeclarations">
                                                    <i class="fa fa-plus"></i>Add Equity Holding
                                                </a>
                                                <a class="btn btn-default" data-toggle="modal" data-target="#modalAddPhysicalShares">
                                                    <i class="fa fa-plus"></i>Add Other Types of Holding
                                                </a><br /><br />
                                                <p>Holdings in Equity</p>
                                        ...
                                        <div class="tab-pane" id="tab5">
                                            <h5 style="padding-left:23px;color:blue;">Submit Declaration</h5>
                                            <table class="table table-striped table-hover table-bordered" style="margin-left: 23px; width: 90%!important;">
                                                
                                                <tbody>
                                                    <tr>
                                                        <td colspan="2">
                                                            You are about to submit your final disclosure
                                                        </td>
                                                    </tr>
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            ...
                                                            <input type="checkbox" id="inAcceptTermsAndConditions" />&nbsp;<span>I hereby declare that I accept the terms and conditions of this policy.</span>
                                            ...
                                            <a id="LinkButtonPreviewForm" class="btn btn-sm blue"  style="margin-left: 23px;" href="#" onclick="javascript:fnPreviewDeclarationForm();">Preview Form</a>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="row">
                            <div id="divRelativeDetail" class="col-md-12">
                                <div class="form-group">
                                    <label id="lblRelation" style="text-align: left" class="col-md-4 control-label">Select Relation<span class="required"> * </span></label>
                                    <div class="col-md-8">
                                        <select id="ddlRelation" runat="server" class="form-control" onchange="javascript:fnRemoveClass(this,'Relation');">
                                        </select>
                                    </div>
                                </div>
                                <br />
								...
								<div class="form-group">
                                    <label id="lblStatusRelation" class="control-label col-md-4">
                                        Select Relationship Status<span class="required">* </span><br />
                                        <u>Select "Not Applicable" if the Relative information is not available</u>
                                    </label>
                                    <div class="col-md-8">
                                        ...
                                        <small class="text-info margin-top-15">To Add New Relative, select “Active”. To remove existing relative from disclosure, select “InActive”</small>
                                    </div>
                                </div>
                                <div class="clearfix"></div>
                                <div class="form-group margin-top-20">
                                    <label id="lblName" style="text-align: left" class="col-md-4 control-label">Relative Name<span class="required"> * </span></label>
                                    <div class="col-md-8">
                                ...
                                <br />
								<div class="form-group">
                                    <label id="lbldppan" class="col-md-4 control-label">Please check here if this relative also works for NIIT Limited</label>
                                    <div class="col-md-8">
                                        <input id="txtdpPan" type="checkbox" />
                                    </div>
                                    <div class="clearfix"></div>
                                </div>
                                
                                <div class="form-group">
                                    <label id="lblEmail" style="text-align: left" class="col-md-4 control-label">Relative Email<span id="spanRelativeEmail" style="display: none" class="required"> * </span></label>
                                    <div class="col-md-8">
                                        <input id="txtEmail" type="text" class="form-control" onkeypress="javascript:fnRemoveClass(this,'Email');" autocomplete="off" />
                                    </div>
                                </div>
                                <br />
                                <br />
                                <div class="form-group">
                                    <label id="lblSkipPan" class="col-md-4 control-label">Please check here in case PAN of Relative is not available</label>
                                    <div class="col-md-8">
                                ...
                                <br />
                                <div class="form-group">
                                    <label id="lblPAN" style="text-align: left" class="col-md-4 control-label">Relative PAN<span class="required"> * </span></label>
                                    <div class="col-md-8">
                                        <input id="txtPAN" type="text" class="form-control" onkeypress="javascript:fnRemoveClass(this,'PAN');" autocomplete="off" oninput="javascript:if(this.value.length>this.maxLength) this.value=this.value.slice(0,this.maxLength); else this.value=this.value.toUpperCase();" maxlength="10" />
                                    </div>
                                </div>
                                <br />
                                <br />
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8">
                                        <input id="txtSameAddressRelation" type="checkbox" onclick="javascript: fnSameAddress();" />
                                    </div>
                                </div>
                                <br />
                                <br />
                                ...
                                <div class="form-group">
                                    <label id="lblAddressRelation" class="col-md-4 control-label">Address<span id="spanRelativeAddress" style="display: none" class="required"> * </span></label>
                                    <div class="col-md-8">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8">
                                        <input id="txtPhoneRelation" type="text" maxlength="10" class="form-control mobile" onkeypress="javascript:fnRemoveClass(this,'PhoneRelation');" autocomplete="off" />
                                    </div>
                                </div>
                                <br />
                                <br />
                    ...
                    <div class="portlet-body form">
                        <div class="row">
                            <div id="divPhysicalShares" class="col-md-12">
                                ...
                                <br />
                                <div class="form-group">
                                    <label id="lblPhysicalDematAccNo" style="text-align: left" class="col-md-4 control-label">Demat Account No<span class="required"> * </span></label>
									<div class="col-md-8">
    ...
    <script src="js/UserDeclaration.js?<%=DateTime.Now %>" type="text/javascript"></script>
