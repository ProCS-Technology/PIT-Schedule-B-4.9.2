<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/InsiderTrading/InsiderTradingMaster.Master" CodeBehind="InitialHoldingAdmin.aspx.cs" Inherits="ProcsDLL.InsiderTrading.InitialHolding" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
            ...
            <div class="portlet light portlet-fit" style="margin-left: -15px; margin-right: -15px; min-height: 560px;">
                <div class="portlet-title">
                    <div class="caption">
                        ...
                        <span class="caption-subject font-red sbold uppercase">Initial holding details</span>
                    </div>
                </div>
                <div class="portlet-body">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <table class="table table-striped table-hover table-bordered" id="tbl-InitialHolding-setup">
                                <thead>
                                    <tr>
    ...
    <div class="modal fade" id="modalInitialHoldingVersion" tabindex="-1" data-backdrop="static" data-keyboard="false">
        <div class="modal-dialog" style="width: 90%;">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
                    <h4 class="modal-title">Initial Holding</h4>
                </div>
                <div class="modal-body" style="overflow-y: scroll; max-height: 441px;">
                    <div class="portlet-body form">
                        <div class="row">
                            <div id="divInitialHoldingVersion" class="col-md-10">
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <script src="js/InitialHoldingAdmin.js?<%=DateTime.Now %>" type="text/javascript"></script>
</asp:Content>
