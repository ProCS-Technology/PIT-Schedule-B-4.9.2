<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/InsiderTrading/InsiderTradingMaster.Master" CodeBehind="MyDetailsAdmin.aspx.cs" Inherits="ProcsDLL.InsiderTrading.MyDetailsAdmin" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <script src="js/MyDetailsAdmin.js?<%=DateTime.Now %>" type="text/javascript"></script>
</asp:Content>
