<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/InsiderTrading/InsiderTradingMaster.Master" CodeBehind="UserNew.aspx.cs" Inherits="ProcsDLL.InsiderTrading.User" %>
                                ...
                                <div class="fileinput fileinput-new" data-provides="fileinput">
                                    ...
                                    <div class="col-md-9">
                                        <div class="btn default btn-file" style="min-width: 350px; max-width: 350px">
                                            <input id="fileUploadImageUserNew" type="file" name="..." onchange="javascript:fnRemoveClass(this,'UploadUserNew','fileUploadImageUserNew');" />
                                        </div>
