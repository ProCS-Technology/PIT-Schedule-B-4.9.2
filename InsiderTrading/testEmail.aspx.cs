    ...
    public partial class testEmail : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            foreach (string f in Request.Files.AllKeys)
            {
                ...
                string url = Path.Combine(HttpContext.Current.Server.MapPath("~/InsiderTrading/emailAttachment/"), file.FileName);
                file.SaveAs(url);
            }
        }
        protected void btnEmailTesting_onClick(object sender, EventArgs e)
        {
