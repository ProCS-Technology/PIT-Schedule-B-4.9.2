<%@ Page Title="Send Welcome Email" Language="C#" MasterPageFile="~/InsiderTrading/InsiderTradingMaster.Master" AutoEventWireup="true" CodeBehind="Send_Welcome_Email.aspx.cs" Inherits="ProcsDLL.InsiderTrading.Send_Welcome_Email" ValidateRequest="false" %>
