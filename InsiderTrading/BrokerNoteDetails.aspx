<%@ Page Title="" Language="C#" MasterPageFile="~/InsiderTrading/InsiderTradingMaster.Master" AutoEventWireup="true" CodeBehind="BrokerNoteDetails.aspx.cs" Inherits="ProcsDLL.InsiderTrading.BrokerNoteDetails" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
            ...
            <div class="portlet-body">
                <div class="row">
                    ...
                    <div class="col-md-2 col-lg-2">
                        <label for="from_date" style="text-align: center; display: block;">Trade From</label>
                    ...
                    <div class="col-md-2 col-lg-2">
                        <label for="to_date" style="text-align: center; display: block;">Trade To</label>
                        <input id="txtToDate" data-date-format="dd/mm/yyyy" type="text" class="form-control date-picker" name="to_date" autocomplete="off"/>
                    </div>
                    <div class="col-md-2 col-lg-2">
                        <label>&nbsp;</label>
                        <input id="txtGetTadingReport" type="button" style="background-color: limegreen;" class="form-control" value="Run" onclick="fnGetTradingReport();" name="to_date" />
                    </div>
                </div>
                <br />
                <br />
                ...
                <br />
                <div class="row">
                    <table class="table table-hover table-bordered" id="tbl-tradeReport-setup">
                        <thead>
                            <tr>
                                <th class="display-none">&nbsp;</th>
                                <th class="display-none">Name</th>
                                <th style="width: 15%;">Name</th>
                                <th style="width: 10%; text-align: center;">Relation</th>
                                <th class="display-none">PAN</th>
                                <th  style="width: 15%; text-align: center;">Requested<br /> Quantity</th>
                                <th  style="width: 15%; text-align: center;">Traded<br /> Quantity</th>
                                <th style="width: 15%; text-align: center;">Requested Date</th>
                                <th  style="width: 15%; text-align: center;">Actual<br /> Trade Date</th>
                            </tr>
                        </thead>
    ...
    <script src="js/BrokerNoteDetails.js?<%=DateTime.Now %>" type="text/javascript"></script>
</asp:Content>