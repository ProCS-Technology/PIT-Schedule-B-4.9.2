<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/InsiderTrading/InsiderTradingMaster.Master" CodeBehind="SMTP_CONFIG_SETUP.aspx.cs" Inherits="ProcsDLL.InsiderTrading.SMTP_CONFIG_SETUP" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
        ...
        <div class="portlet light portlet-fit ">
            <div class="portlet-title">
                <div class="caption">
                    ...
                    <span class="caption-subject font-red sbold uppercase">SMTP CONFIGURATION</span>
                </div>
            </div>
                    ...
                    <div class="col-md-6" style="border-right: 1px solid black;">
                        <div class="form-body">
                                ...
                                <div class="col-md-9">
                                    <div class="input-inline input-medium">
                                        <div class="input-group">
                                            ...
                                            <input id="txtDefaultEmail" type="email" class="form-control" placeholder="Enter DEFAULT EMAIL" />
                                ...
                                <div class="col-md-9">
                                    <div class="input-inline input-medium">
                                        <div class="input-group">
                                            ...
                                            <input id="txtContinualDisclosureEmail" type="text" class="form-control" placeholder="Enter DISCLOSURE EMAIL" />
                                        </div>
                                    </div>
                                    <span class="help-inline"><i class="fa fa-info-circle" title="Inline help." aria-hidden="true"></i></span>
                                </div>
                                ...
                                <div class="col-md-9">
                                    <div class="input-inline input-medium">
                                        <div class="input-group">
                                            ...
                                            <input id="txtSmtpHostName" type="text" class="form-control" placeholder="Enter SMTP HOST NAME" />
                                        </div>
                                    </div>
                                    <span class="help-inline"><i class="fa fa-info-circle" title="Inline help." aria-hidden="true"></i></span>
                                </div>
                                ...
                                <div class="col-md-9">
                                    <div class="input-inline input-medium">
                                        <div class="input-group">
                                            ...
                                            <input id="txtPortNumber" type="text" class="form-control number" placeholder="Enter PORT" />
                                        </div>
                                    </div>
                                    <span class="help-inline"><i class="fa fa-info-circle" title="Inline help." aria-hidden="true"></i></span>
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-9">
                                    <div class="input-inline input-medium">
                                        <select id="txtSsl" class="form-control">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-9">
                                    <div class="input-inline input-medium">
                                        <select id="txtUserDefaultCredential" class="form-control">
                                            <option value="0">Select</option>
                                            <option value="Yes">Yes</option>
                                            <option value="No">No</option>
                                        </select>
                                ...
                                <div class="col-md-9">
                                    <div class="input-inline input-medium">
                                        <div class="input-group">
                                            ...
                                            <input id="txtSmtpUserName" class="form-control" type="text" placeholder="Enter SMTP USER NAME" />
                                        </div>
                                    </div>
                                    <span class="help-inline"><i class="fa fa-info-circle" title="Inline help." aria-hidden="true"></i></span>
                                </div>
                                ...
                                <div class="col-md-9">
                                    <div class="input-inline input-medium">
                                        <div class="input-group">
                                            ...
                                            <input id="txtPassword" class="form-control" type="password" placeholder="Enter PASSWORD"   autocomplete="off" />
                                        </div>
                                    </div>
                                    <span class="help-inline"><i class="fa fa-info-circle" title="Inline help." aria-hidden="true"></i></span>
                                </div>
                                ...
                                <div class="col-md-9">
                                    <div class="input-inline input-medium">
                                        <div class="input-group">
                                            ...
                                            <input id="txtSmtpUserNameOutgoing" class="form-control" type="text" placeholder="Enter SMTP USER NAME" />
                                        </div>
                                    </div>
                                    <span class="help-inline"><i class="fa fa-info-circle" title="Inline help." aria-hidden="true"></i></span>
                                </div>
                                ...
                                <div class="col-md-9">
                                    <div class="input-inline input-medium">
                                        <div class="input-group">
                                            ...
                                            <input id="txtPasswordOutgoing" class="form-control" type="password" placeholder="Enter PASSWORD" />
                                        </div>
                                    </div>
                                    <span class="help-inline"><i class="fa fa-info-circle" title="Inline help." aria-hidden="true"></i></span>
                                </div>
                    ...
                    <div class="form-actions">
                        <div class="row">
                            <div class="col-md-offset-3 col-md-9">
                                <button id="btnSave" type="submit" class="btn green" onclick="javascript:fnSaveSmtpConfig();">Save</button>
                                <a href="SMTP_CONFIG_SETUP.aspx" class="btn default">Cancel</a>
                            </div>
                        </div>
                    </div>
                </form>
    ...
    <script src="js/SmtpConfig.js?<%=DateTime.Now %>" type="text/javascript"></script>
</asp:Content>
