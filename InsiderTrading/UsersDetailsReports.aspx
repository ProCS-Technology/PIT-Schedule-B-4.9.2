<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/InsiderTrading/InsiderTradingMaster.Master" CodeBehind="UsersDetailsReports.aspx.cs" Inherits="ProcsDLL.InsiderTrading.UsersDetailsReports" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
        ...
        <div class="portlet box">
            <div class="portlet-title">
                <div class="caption">
                    ...
                    <span class="caption-subject font-red sbold uppercase">Users Details</span>
                </div>
                <div class="tools">
                </div>
            </div>
            <div class="portlet-body">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div style="text-align: center"><b>User Status</b></div>
                        <br />
                        <div id="chart_Users" class="chart" style="height: 200px;">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div style="text-align: center"><b>User Modifications</b></div>
                        <br />
                ...
                <br />
                <div class="row">
                    <div style="text-align: center"><b>User Details</b></div>
                    <table class="table table-striped table-hover table-bordered" id="tbl-userDetails-setup" style="margin-left: 16px;width: 1043px;">
                        <thead>
                            <tr>
                                <th>Name</th>
                                <th>Email Id</th>
    ...
    <script src="js/UsersDetailsReports.js" type="text/javascript"></script>
</asp:Content>
