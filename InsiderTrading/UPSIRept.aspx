<%@ Page Language="C#" MasterPageFile="~/InsiderTrading/InsiderTradingMaster.Master" ValidateRequest="false" AutoEventWireup="true" CodeBehind="UPSIRept.aspx.cs" Inherits="ProcsDLL.InsiderTrading.UPSIRept" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
                ...
                <table class="table table-striped table-hover display text-nowrap table-bordered" id="tbl-UPSIReport-setup">
                    <thead>
                        <tr>
                            ...
                            <th colspan="8" style="text-align:center;">Other Details</th>
                        </tr>
                        <tr>
                            <th>Name</th>
							...
							<th>UPSI Created On</th>
							<th>UPSI Made By</th>							
                            <th>Remarks, if any</th>
                            <th id="tdMsgAttachment" runat="server" visible="false"></th>
                        </tr>
                    </thead>
    ...
    <script src="js/UPSIRept.js?<%=DateTime.Now %>" type="text/javascript"></script>
</asp:Content>